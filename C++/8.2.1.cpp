...
// using namespace std;
// int main() {
//     vector<string> readfilebyword(const string &filename);
//     vector<string> words = readfilebyword("example.txt");
//     cout << "Words read from file:" << endl;
...
int main(int argc, char* argv[]) {
    if (argc != 2) {//共两个命令行参数，一个是程序名，一个是文件名
